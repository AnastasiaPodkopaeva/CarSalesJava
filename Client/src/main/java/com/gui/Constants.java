...
public class Constants {
    ...
    public static final String USER_CARS_FXML="UserCars.fxml";
    public static final String CARS_REVIEW_FXML="CarsReview.fxml";
    ...
    public static final String ADMIN_CARS_FXML="AdminCars.fxml";
