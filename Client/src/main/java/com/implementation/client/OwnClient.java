...
public class OwnClient {
    ...
    private Car selectableCarForReview;
    ...
    public Car getSelectableCarForReview() {
        return selectableCarForReview;
    }

    public void setSelectableCarForReview(Car selectableCarForReview) {
        this.selectableCarForReview = selectableCarForReview;
    }
    ...
    public Vector<Car> receiveCars() {
        try {
            return (Vector<Car>) input_stream.readObject();
        }catch (IOException |ClassNotFoundException e){
            e.printStackTrace();
        }
        return null;
